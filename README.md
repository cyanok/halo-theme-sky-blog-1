...
| 📊 GitHub 热力图 | 贡献统计展示 |
| 🖼️ 高级图库 | JS Masonry 瀑布流，无限滚动，自定义参数 |
...
| 存储插件 | 图片 | 视频 | 音频 | 状态 | 说明 |
|---------|------|------|------|------|------|
| Docsme 文档 | [app-yffxw](https://www.halo.run/store/apps/app-yffxw) | - | ✅ 知识库文档、专属宽版路由模板 |
| 图库管理 | [app-BmQJW](https://www.halo.run/store/apps/app-BmQJW) | [plugin-photos](https://github.com/halo-sigs/plugin-photos) | ✅ 瀑布流相册（Masonry 无限滚动） |
| 链接管理 | [app-hfbQg](https://www.halo.run/store/apps/app-hfbQg) | [plugin-links](https://github.com/halo-sigs/plugin-links) | ✅ 友链书签（支持分组API分发） |
